(() => {
    ...
    const script_element = document.querySelector("#tel1");
    const maskOptions = {
        mask: "+{7}(000)000-0000"
    };
    ...
    script_select.firstElementChild.addEventListener("click", (function(e) {
        e.preventDefault();
        if (script_select.classList.contains("close")) script_select.classList.remove("close"); else script_select.classList.add("close");
    }));
    isWebp();
    tabs();
})();